<?php namespace AWME\Stocket\Components;
...
use AWME\Stocket\Models\Order as ShopOrder;
use AWME\Stocket\Models\Product as ShopProduct;
...
class Basket extends ComponentBase
{
    ...
    public function onAddProduct()
    {
        ...
        Cart::associate('Product', 'AWME\Stocket\Models')->add(
            $id,
            $product->title,
            $quantity,
            $product->price
    ...
    public function onCheckout()
    {
        ...
        Mail::sendTo(post('email'), 'awme.Stocket::mail.orderconfirm', [
            'admin' => false,
        ...
        Mail::sendTo($this->recipientEmail, 'awme.Stocket::mail.orderconfirm_admin', [
            'admin'   => true,
